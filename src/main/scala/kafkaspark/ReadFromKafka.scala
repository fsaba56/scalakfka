...
object ReadFromKafka {
  def main(args: Array[String]): Unit = {
    ...
    df.writeStream.format("parquet").option("checkpointLocation", "/tmp/kafka/trainarrival/checkpoint").option("path", "/tmp/kafka/trainarrival/data").start().awaitTermination()
